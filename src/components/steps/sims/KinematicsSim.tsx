    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        <div className="rounded-xl bg-slate-100 px-3 py-2 dark:bg-slate-800">
          <div className="text-xs text-slate-600 dark:text-slate-300">Final velocity at t = {T}s</div>
          <div className="text-lg font-bold" data-testid="final-velocity">
            {finalV} m/s
          </div>
        </div>
        <div className="rounded-xl bg-slate-100 px-3 py-2 dark:bg-slate-800">
          <div className="text-xs text-slate-600 dark:text-slate-300">Displacement</div>
