...
export function AiToggle({
  ...
  if (variant === "compact") {
    return (
      <label
        className="flex cursor-pointer items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-semibold text-slate-600 hover:bg-slate-200"
        title={HELPER}
      >
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-2xl bg-white p-4 ring-1 ring-slate-200">
      <div className="min-w-0">
        <p className="font-semibold text-ink">AI questions</p>
